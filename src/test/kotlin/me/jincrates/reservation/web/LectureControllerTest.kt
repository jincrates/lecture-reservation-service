...
class LectureControllerTest {
    ...
    fun createLectureSuccessTest() {
        ...
        mockMvc.perform(post("/api/v1/rooms/${newRoom.id}/lectures")
            ...
            .andExpect(jsonPath("\$.title").value(lectureRequest.title))
            .andExpect(jsonPath("\$.description").value(lectureRequest.description))
            .andExpect(jsonPath("\$.lecturerName").value(lectureRequest.lecturerName))
            .andExpect(jsonPath("\$.limitOfReservations").value(lectureRequest.limitOfReservations))
            .andExpect(jsonPath("\$.openedAt").value(lectureRequest.openedAt.format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss"))))
            .andExpect(jsonPath("\$.closedAt").value(lectureRequest.closedAt.format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss"))))
            .andDo(print())
    ...
    fun createLectureFailTest1() {
        ...
        mockMvc.perform(post("/api/v1/rooms/${newRoom.id}/lectures")
            ...
            .andExpect(jsonPath("\$.message").value("강연 제목을 입력하지 않았습니다."))
            .andDo(print())
    ...
    fun createLectureFailTest2() {
        ...
        mockMvc.perform(post("/api/v1/rooms/${newRoom.id}/lectures")
            ...
            .andExpect(status().isOk)
            .andExpect(jsonPath("$.code").value(400))
            .andExpect(jsonPath("\$.message").value("강연 제목은 50자까지만 입력할 수 있습니다."))
            .andDo(print())
    ...
    fun createLectureFailTest3() {
        ...
        mockMvc.perform(post("/api/v1/rooms/${newRoom.id}/lectures")
            ...
            .andExpect(status().isOk)
            .andExpect(jsonPath("$.code").value(400))
            .andExpect(jsonPath("\$.message").value("강연 상세내용을 입력하지 않았습니다."))
            .andDo(print())
    ...
    fun createLectureFailTest4() {
        ...
        mockMvc.perform(post("/api/v1/rooms/${newRoom.id}/lectures")
            ...
            .andExpect(status().isOk)
            .andExpect(jsonPath("$.code").value(400))
            .andExpect(jsonPath("\$.message").value("강연자명을 입력하지 않았습니다."))
            .andDo(print())
    ...
    fun createLectureFailTest5() {
        ...
        mockMvc.perform(post("/api/v1/rooms/${newRoom.id}/lectures")
            ...
            .andExpect(status().isOk)
            .andExpect(jsonPath("$.code").value(400))
            .andExpect(jsonPath("\$.message").value("예약 마감인원은 1명 이상이여야 합니다."))
            .andDo(print())
    ...
    fun createLectureFailTest6() {
        ...
        mockMvc.perform(post("/api/v1/rooms/${newRoom.id}/lectures")
            ...
            .andExpect(status().isOk)
            .andExpect(jsonPath("$.code").value(400))
            .andExpect(jsonPath("\$.message").value("강연 시작일시를 정확히 입력하세요."))
            .andDo(print())
    ...
    fun createLectureFailTest7() {
        ...
        mockMvc.perform(post("/api/v1/rooms/${newRoom.id}/lectures")
            ...
            .andExpect(status().isOk)
            .andExpect(jsonPath("$.code").value(400))
            .andExpect(jsonPath("\$.message").value("강연 종료일시를 정확히 입력하세요."))
            .andDo(print())
    ...
    fun updateLectureSuccessTest() {
        ...
        mockMvc.perform(put("/api/v1/rooms/${room.id}/lectures/${newLecture.id}")
            ...
            .andExpect(status().isOk)
            .andExpect(jsonPath("\$.title").value(updateLectureRequest.title))
            .andExpect(jsonPath("\$.description").value(updateLectureRequest.description))
            .andExpect(jsonPath("\$.lecturerName").value(updateLectureRequest.lecturerName))
            .andExpect(jsonPath("\$.limitOfReservations").value(updateLectureRequest.limitOfReservations))
            .andExpect(jsonPath("\$.openedAt").value(updateLectureRequest.openedAt.format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss"))))
            .andExpect(jsonPath("\$.closedAt").value(updateLectureRequest.closedAt.format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss"))))
            .andDo(print())
